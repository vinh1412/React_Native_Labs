    ...
    <SafeAreaView style={{ backgroundColor: '#C4C4C4', flex: 1 }}>
      <ScrollView contentContainerStyle={{ flex: 1 }}>
        ...
        <View style={{ backgroundColor: 'white', height: 350 }}>
          ...
          <View
            ...
            <View
              ...
              <View>
                <Text
                  style={{ color: '#011627', fontWeight: 700, fontSize: 12 }}>
                  Mã giảm giá đã lưu
                </Text>
              </View>
            </View>
            ...
            <View
              ...
              <Text style={{ color: '#EE0D0D', fontWeight: 700, fontSize: 18 }}>
                141.800 đ
              </Text>
              <Text
                style={{
              ...
              <View
                ...
                <View>
                  <Text
                    style={{ color: '#134FEC', fontWeight: 700, fontSize: 12 }}>
                    Mua sau
                  </Text>
                </View>
              </View>
        ...
        <View
          ...
          <Text style={{ fontWeight: 700, fontSize: 12, color: '#134FEC' }}>
            Nhập tại đây?
          </Text>
        </View>
        {/*View footer*/}
        <View
          ...
          <View
            ...
            <Text style={{ fontWeight: 700, fontSize: 18, color: '#EE0D0D' }}>
          ...
          <View
            ...
            <View
              ...
              <Text style={{ color: '#808080', fontSize: 18, fontWeight: 700 }}>
                Thành tiền
              </Text>
              <View style={{ width: 100 }}></View>
              <Text style={{ color: '#EE0D0D', fontSize: 20, fontWeight: 700 }}>
                {price.toLocaleString()} đ
              </Text>
            </View>
            {/** Button Order */}
